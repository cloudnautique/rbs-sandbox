...
type VolumeOperations interface {
	...
	ActionError(*Volume) (*Volume, error)
...
func (c *VolumeClient) ActionError(resource *Volume) (*Volume, error) {

	resp := &Volume{}

	err := c.rancherClient.doAction(VOLUME_TYPE, "error", &resource.Resource, nil, resp)
